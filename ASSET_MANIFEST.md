...
| File | Subject |
|---|---|
| `assets/food-planets/crt-clean-16x9/beef-ball-planet.png` | Beef ball planet |
| `assets/food-planets/crt-clean-16x9/shengjianbao-planet.png` | Shengjianbao planet |
| `assets/food-planets/crt-clean-16x9/pasta-planet.png` | Pasta planet |
| `assets/food-planets/crt-clean-16x9/cheese-planet.png` | Cheese planet |
| `assets/food-planets/crt-clean-16x9/tofu-planet.png` | Tofu planet |
| `assets/food-planets/crt-clean-16x9/century-egg-planet.png` | Century egg planet |
| `assets/food-planets/crt-clean-16x9/fried-potato-ball-planet.png` | Fried potato ball planet |
| `assets/food-planets/crt-clean-16x9/cabbage-planet.png` | Cabbage planet |
...
| File | Subject |
|---|---|
| `assets/food-planets/crt-interface-16x9/beef-ball-planet-interface.png` | Beef ball interface study |
| `assets/food-planets/crt-interface-16x9/shengjianbao-planet-interface.png` | Shengjianbao interface study |
| `assets/food-planets/crt-interface-16x9/pasta-planet-interface.png` | Pasta interface study |
| `assets/food-planets/crt-interface-16x9/cheese-planet-interface.png` | Cheese interface study |
| `assets/food-planets/crt-interface-16x9/tofu-planet-interface.png` | Tofu interface study |
| `assets/food-planets/crt-interface-16x9/century-egg-planet-interface.png` | Century egg interface study |
| `assets/food-planets/crt-interface-16x9/fried-potato-ball-planet-interface.png` | Fried potato ball interface study |
| `assets/food-planets/crt-interface-16x9/cabbage-planet-interface.png` | Cabbage interface study |
| `assets/food-planets/crt-interface-16x9/vinegar-jelly-planet-interface.png` | Vinegar jelly interface study |
| `assets/food-planets/crt-interface-16x9/ketchup-planet-interface.png` | Ketchup interface study |
